...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both TsmsUI.css and TsmsUI.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/TsmsUI.css": "build/less/TsmsUI.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/TsmsUI.min.css": "build/less/TsmsUI.less",
          // Skins minified
