...
?>
          <form action="" method="POST">
            <input type="text" class="form-control" name="username1" placeholder="Enter Username" value="<?php echo escape(Input::get('username1')); ?>" required autocomplete="off"/>
            ...
            <select type="text" name="gender" class="form-control" placeholder="Gender" value="<?php echo escape(Input::get('gender')); ?>" autocomplete="off">
                <option> -- -- </option>
                <option value="Male"> Male</option>
                <option value="Female">Female</option>
            </select>
            <input type="tel" name="phone" placeholder="Phone Number" required value="<?php echo escape(Input::get('phone')); ?>" autocomplete="off"/>
