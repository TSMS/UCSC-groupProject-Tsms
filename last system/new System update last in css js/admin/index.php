            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <!-- Menu Body -->
                  <li class="user-body">
                    <center><i class="fa fa-power-off"><a href="content/lockscreen.php">  Screen Lock</a></i></center>
                  </li>
                  <!-- Menu Footer-->
...
<!-- I have to make it for success id dont know how to slove this problem, if i remove this it isnt work, but this ul doing nothin in page -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="supply_update"><i class="fa fa-circle-o"></i> Supply</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="registation"><i class="fa fa-circle-o"></i> Registation</a></li>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="control-sidebar-home-tab">
            ...
            <ul class="control-sidebar-menu">
              <li>
                <a href="javascript::;">
                  <i class="menu-icon fa fa-exclamation-circle bg-yellow"></i>
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Dashbord Not Connect</h4>
                    <p>Should be connectted</p>
                  </div>
                </a>
              </li>
